...
// Angie Yahaira Campos Aris
// 20222000215

namespace P26_Control_Registro_Llamadas_MCVR_CP
{
    public partial class frmLlamadasMVRCP : Form
    {
        public frmLlamadasMVRCP()
        {
            InitializeComponent();
            tHora.Enabled = true;
        }

        private void frmLlamadasMVRCP_Load(object sender, EventArgs e)
        {
